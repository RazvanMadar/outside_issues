...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    public ResponseEntity<Object> generateToken(AuthenticationRequest request) {
        try {
            ...
            return ResponseEntity.ok(new AuthenticationResponse(citizen.getId(), citizen.getEmail(), citizen.getRoles().iterator().next().getName(), token, citizen.getFirstName(), citizen.getLastName()));
