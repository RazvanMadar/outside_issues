...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .and()
                .authorizeRequests()
                .antMatchers("/login", "/api/issues/basic-statistics/**", "/api/issues/year-statistics/**", "/api/email", "/api/issues/filtered/**","/api/issues",  "/api/citizen-reactions", "/api/images/*", "/api/issues/type-statistics/**", "/api/citizens/auth/**", "/api/citizen/images/*", "/send/**", "/sendMessage/**", "/send-message/**", "/send-update/**", "/topic/**", "/message/**", "/app/**", "/ws-message/**", "/sender/**").permitAll()
